...
class ShowSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = models.Show
        fields = ('id', 'url', 'name', 'description', 'location', 'runtime', 'interval_number', 'description', 'long_description', 'long_markdown', 'start_date', 'end_date', 'is_current', 'poster', 'small_poster', 'warnings', 'category', 'occurrence_set', 'show_sold_out')
